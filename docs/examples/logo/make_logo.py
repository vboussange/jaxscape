...
from jaxscape import ResistanceDistance, LCPDistance
...
COLORS_BR = ["#2d00f7","#6a00f4","#8900f2","#a100f2","#b100e8","#bc00dd","#d100d1","#db00b6","#e500a4","#f20089"]
...
for coord in node_coords:
  circle = plt.Circle((coord[0], coord[1]), radius=6, fill=False, edgecolor='#f72585', linewidth=2)
  ax.add_patch(circle)
plt.axis("off")
fig.tight_layout()
