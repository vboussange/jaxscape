...
def _connectivity(quality_raster: Array, permeability_raster: Array, window_op: WindowOperation, distance: AbstractDistance, proximity: Callable[[Array], Array], q_weighted: bool) -> Union[Array, float]:
    ...
    def run(self, q_weighted: bool = True) -> Array:
        ...
        **Returns:**
        ...
        for (xy_batch, quality_batch) in tqdm(
            ...
            output += jnp.sum(_connectivity_vmap(quality_windows, permeability_windows, self.window_op, self.distance, self.proximity, q_weighted))
        return output
