...
def create_landscape(size):
    ...
    return habitat_permability, habitat_quality, activities, nb_active
...
def benchmark(device, fun):
    ...
    for size in node_sizes:
        ...
        habitat_permability, habitat_quality, activities, nb_active = create_landscape(size)
...
size = 150
habitat_permability, habitat_quality, activities, nb_active = create_landscape(size)
calculate_d_ech_dp(habitat_permability, habitat_quality, activities, 1, nb_active)  # This fails for N > 200
...
fig.savefig(path_results / "benchmark_forward_pass.png")
...
fig, ax = plot_benchmark(cpu_times, gpu_times)
fig.savefig(path_results / "benchmark_backward_pass.png")